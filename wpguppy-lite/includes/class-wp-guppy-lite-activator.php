	...
	public static function activate() {
		...
		if ($wpdb->get_var("SHOW TABLES LIKE '$wpguppy_message'") != $wpguppy_message) {            
			$privateChat = "CREATE TABLE $wpguppy_message (
				...
				sp_sender_id 		varchar(100) DEFAULT NULL COMMENT 'guest / registered user id',
				sp_rec_id 			varchar(100) DEFAULT NULL COMMENT 'guest / registered user id',
				...
				group_msg_seen_id 	varchar(100) DEFAULT NULL  		COMMENT 'group member message seen ids',
